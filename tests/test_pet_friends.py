...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='Кот', age='2', pet_photo='images/Karlson.jpg'):
    ...
    name = 'Рыжик Пушок Снежок Ласка Василий Шнырь Профессор Киса Васька Пират'
...
# Test 8
def test_add_pet_with_numbers_in_variable_animal_type(name='Karlson', animal_type='891230', age='0', pet_photo='images/Karlson.jpg'):
    """Проверка с негативным сценарием.
